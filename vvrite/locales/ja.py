...
strings = {
    ...
    "settings": {
        ...
        "remote": {
            ...
            "llm_title": "校正 (LLM)",
            "llm_model_placeholder": "モデル名（例: qwen3-8b）",
            "llm_context_placeholder": "話者の情報を1行で",
            "not_asr": "ASRサーバーではありません — アドレスを確認してください",
            "correction": "誤認識された単語をLLMで修正",
            "correction_hint": "認識後にサーバー上で実行されます。専門用語の精度が上がりますが、約2秒長くかかります。",
            "screen_context": "画面に表示されている単語を校正のヒントに使う",
            "screen_context_hint": "話している間に最前面のウィンドウを読み取り、画面上の名前を正しく表記します。画面収録の許可が必要です。遅延はありません。",
        },
        "custom_words": {
            "title": "カスタムワード",
